    ...
    return (
        <>
            ...
            <div class="side-wrapper">
                ...
                <div class="side-menu">
                    <a onClick={()=> setCategory('Front-End')} href="#">
                    ...
                    <a onClick={()=> setCategory('Back-End')} href="#">
                    ...
                    <a onClick={()=>setCategory('Android')} href="#">
                        <svg viewBox="0 0 512 512" fill="currentColor">
                            <path
                    ...
                    <a onClick={()=>setCategory('UI/UX')} href="#">
                        <svg viewBox="0 0 512 512" fill="currentColor">
                            <path
                    ...
                    <a onClick={()=>setCategory('Full-Stack')} href="#">
                        <svg viewBox="0 0 512 512" fill="currentColor">
                            <path
